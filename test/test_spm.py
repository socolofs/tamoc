...
def check_sim(particles, R, maxit, toler, delta_z, spm):
    ...
    assert spm.zi[-1] <= 0.
    ans = np.array([5.53639856e+00, 2.45836465e+00, 2.00750230e+02, 
        6.79757478e+09, 2.11229969e-02, 0.00000000e+00, 0.00000000e+00, 
        1.25770390e+04, 6.18776198e+02, 0.00000000e+00, 0.00000000e+00, 
        0.00000000e+00, 5.00000000e+01, 2.97709626e+07, 7.50209660e+02, 
        0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 4.04213391e-02, 
        0.00000000e+00, 0.00000000e+00])
    for i in range(len(ans)):
