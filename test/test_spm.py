...
def check_sim(particles, R, maxit, toler, delta_z, spm):
    ...
    assert spm.zi[-1] <= 0.
    ans = np.array([5.45776722e+00, 2.45113868e+00, 1.97911133e+02, 
        6.70101072e+09, 2.10774066e-02, 0.00000000e+00, 0.00000000e+00, 
        1.25498549e+04, 6.19471629e+02, 5.00000000e+01, 2.97708706e+07, 
        7.51091957e+02, 3.99127972e-02, 0.00000000e+00, 0.00000000e+00])
    for i in range(len(ans)):
