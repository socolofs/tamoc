...
carbon-dioxide bubble rising through the water column.  This script demonstrates
...
if __name__ == '__main__':
    ...
    bm54.close_nc()
    bm54.add_computed_gas_concentrations()
    ...
    composition = ['carbon_dioxide', 'nitrogen', 'oxygen', 'argon']
    ...
    sbm.save_sim('./CO2_bubble.nc', '../../test/output/test_bm54.nc', 
                 'Results of ./CO2_bubble.py script')
    
    # Save the data for importing into Matlab
    sbm.save_txt('./CO2_bubble', '../../test/output/test_bm54.nc', 
                 'Results of ./CO2_bubble.py script')
