...
and test whether it is possible to include a component with zero mol fraction
in the mixture.
...
if __name__ == '__main__':
    ...
    composition = ['methane', 'n-butane', 'n-decane', 'oxygen']
    oil = dbm.FluidMixture(composition)
    yk = np.array([0.5301, 0.1055, 0.3644, 0.])
    m = oil.masses(yk)
